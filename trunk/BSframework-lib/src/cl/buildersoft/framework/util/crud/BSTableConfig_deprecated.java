...
public class BSTableConfig_deprecated implements Serializable {
	...
	@Deprecated
	public BSTableConfig_deprecated(String database) {
		this.database = database;
	}

	public BSTableConfig_deprecated(String database, String tableName) {
		this(database, tableName, null);
	}

	public BSTableConfig_deprecated(String database, String tableName, String viewName) {
		this.database = database;
